...
| 4 | **Số lượng vs phân tích** | **Cập nhật 23/07/2026 (chỉ thị người dùng): SÀN CỨNG mỗi phiên `worldNews` ≥10 · `usNews` ≥10 tin chất lượng — chưa đủ chưa dừng** (giao thêm agent, không bịa/không nới ngày). Vẫn KHÔNG sàn cứng mỗi *category* (sàn ở cấp MỤC LỚN). Chi tiết ở "Chỉ tiêu số lượng" trong `CLAUDE.md`. |
