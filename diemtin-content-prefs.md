...
| 4 | **Số lượng vs phân tích** | **Cập nhật 23/07/2026 (chỉ thị người dùng): SÀN CỨNG TỔNG NGÀY `worldNews` ≥15 · `usNews` ≥15 tin chất lượng** (gộp sáng+tối; sáng nhắm ~10/mục, tối bù đủ 15) — **chưa đủ chưa dừng** (giao thêm agent, không bịa/không nới ngày). ⚠️ LỖI THỜI từ 23/07/2026 (bỏ sàn 15+15) và từ 05/09/2026 nay ĐÃ CÓ sàn cấp MỤC: `SAN_MOI_MUC` tin mỗi mục của file Word — 05 tin từ 18/09/2026, xem `scripts/soi_muc_cam.py`. Chi tiết ở "Chỉ tiêu số lượng" trong `CLAUDE.md`. |
