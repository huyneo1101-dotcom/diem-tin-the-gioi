...
## PHÁT HIỆN sở thích (cập nhật 17/07/2026 — từ 142 lượt vote, độ tin cậy CAO, đã BỎ QUA ngày tháng)
Nguồn: `preferences.json` (`stats` + `items`). 114 👍 / 28 👎 (146 tiêu đề). Gồm tin thật + tin mẫu cân bằng + vote trực tiếp trên mục Bị loại → tách rõ trục sở thích.

> **PHÁT HIỆN MỚI QUAN TRỌNG (17/07):** lần đầu **CNQS (44👍/3👎)** và **Ngoại giao (32👍/3👎)** có vote 👎. Nhưng **CẢ 6 tin 👎 đó đều là tin đã bị đưa vào mục 🚫 Bị loại** — chủ trang vào Bị loại bấm 👎 xác nhận. Tức KHÔNG phải ghét category, mà **xác nhận đúng những tin YẾU bên trong category**: CNQS ghét **bàn giao/mua sắm thường quy** (xe Jackal 3), **tin xung đột lặp** (Nga-Ukraine đánh tàu), **đe dọa/tình báo "nguồn tin nói" chưa xác nhận** (Iran-Houthi Bab el-Mandeb); Ngoại giao ghét **"sẽ họp/tham vấn chưa kết quả"** (ASEAN-Myanmar), **MOU nhỏ/khu vực phụ** (AFRICOM-Morocco), **đàm phán không văn kiện** (Israel-Lebanon Rome). → Bộ lọc hiện tại ĐÚNG; càng siết "khí tài/hệ thống/thoả thuận CÓ KẾT QUẢ cụ thể", né "thường quy · lặp · tin đồn · chưa kết quả" ngay cả trong 2 category thích nhất.

### 🟢 THÍCH — điểm chung
- **Trục chủ đề rõ nhất:** **Công nghệ quân sự (44👍/3👎)** và **Ngoại giao (32👍/3👎)** vẫn thích áp đảo (3👎 chỉ là tin yếu ở Bị loại, xem ô trên). **Kinh tế vĩ mô (24👍/3👎)** thích mạnh (3👎 đều là earnings công ty: UBS, Delta, VW). Trục CNQS + Ngoại giao vẫn là số 1.
