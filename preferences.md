...
## PHÁT HIỆN sở thích (cập nhật 13/07/2026 tối — từ 131 lượt vote, độ tin cậy CAO, đã BỎ QUA ngày tháng)
Nguồn: `preferences.json` (`stats` + `items`). 109 👍 / 22 👎 (135 tiêu đề). Gồm tin thật + tin mẫu cân bằng + nhiều vote cứu tin CNQS ở mục Bị loại → tách rõ trục sở thích.

### 🟢 THÍCH — điểm chung
- **Trục chủ đề rõ nhất:** **Công nghệ quân sự (41👍/0👎)** và **Ngoại giao (31👍/0👎)** — thích TUYỆT ĐỐI, không một tin nào bị ghét. **Kinh tế vĩ mô (23👍/3👎)** cũng thích mạnh. CNQS bứt lên +9 nhờ chủ trang cứu loạt tin khí tài (Aselsan Steel Dome, Đức mua Tomahawk, LRASM/JASSM, MQ-25A…) từ mục Bị loại — càng khẳng định đây là trục số 1.
