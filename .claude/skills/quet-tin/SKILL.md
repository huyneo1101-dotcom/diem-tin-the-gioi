...
| 6 | exercises + dipEvents (cập nhật `ongoing` + tạo mới nếu có) — **BẮT BUỘC tìm diễn biến "Predator's Run 2026"** (đang diễn ra tới ~29/7) | 1–2 mỗi loại |
...
- **🎯 TRỌNG TÂM CHỦ ĐỘNG (chỉ thị người dùng 23/07 — GHI ĐÈ dòng LOẠI BỎ khi va chạm):** mỗi phiên
  chủ động tìm 1–2 tin mỗi trọng tâm nếu có: **(1) Úc** (AUKUS, QP Úc, an ninh Úc–Mỹ/Nhật/Anh — region
  "Ấn Độ Dương - Thái Bình Dương"); **(2) Biển Đông** (chủ quyền, đụng độ, tuần tra, phán quyết —
  region "Đông Á"); **(3) Nội bộ Mỹ trong usNews: MỞ TOÀN BỘ** — nhận cả chính trị nhân vật, đảng phái,
  horserace bầu cử, nhập cư, cải cách tư pháp, biểu tình, điều trần (KHÔNG áp các dòng LOẠI BỎ về chính
  trị). Chỉ vẫn loại cáo phó thuần + giải trí/đời tư phi chính sách. **Ngoại lệ này CHỈ cho usNews** —
  tin thế giới ngoài Mỹ vẫn theo bộ lọc gốc. Agent Chính trị (số 2) gánh chính phần nội bộ Mỹ này; Úc và
  Biển Đông rải cho agent CNQS/Ngoại giao/Kinh tế tuỳ nội dung.
- **📌 HAI CHỦ ĐỀ CHÚ TRỌNG HÀNG NGÀY (chỉ thị người dùng 23/07):** **(a) Tập trận Predator's Run 2026**
  (Mỹ–Úc–Philippines, Townsville, tới ~29/7) → agent 6 BẮT BUỘC tìm diễn biến mới, cập nhật qua
  `exerciseUpdates` (tên khớp: `"Predator's Run 2026 (tập trận Mỹ - Úc - Philippines)"`); kết thúc thì đổi
  status→recent. **(b) Mỹ–Mali** (Mỹ cân nhắc/không kích JNIM ở Sahel) → agent Chính trị + CNQS theo dõi,
  đa số là usNews; tin gắn Mali/JNIM/Bamako/Sahel để tự vào dossier `🟤 Mỹ – Mali`. Nguồn: AFRICOM/
  defense.gov/state.gov, Reuters/AP/AFP, WaPo.
