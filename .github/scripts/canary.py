...
def main() -> int:
    ...
    if lan:
        ...
        # ⛔ SAI GIỜ và MỤC CÂM là HAI lớp ĐỘC LẬP — trước 17/09/2026 nhánh SAI GIỜ `return`
        # ngay nên `canh_bao_muc_cam` không bao giờ chạy tới khi gửi trễ giờ. Sự cố thật
        # 17/09: bản tin sáng gửi 04:37 (trễ hạn 04:30) nên canary chỉ kêu SAI GIỜ, mục "Đối
